...
export const KeyIcon = createIcon({
  ...
  path: (
    <path
      d="M4.186 3.34c0 .279 0 .55.088.803C3.348 5.23.904 8.103.676 8.322a.433.433 0 00-.144.322c0 .183.111.359.206.458.142.148.748.709.86.601.33-.322.397-.408.532-.541.204-.2-.021-.608.05-.774.07-.165.146-.197.268-.223.123-.026.34.062.51.064.178.003.274-.073.408-.197.107-.1.184-.192.186-.335.005-.194-.275-.45-.066-.654.208-.204.509.134.73.108.222-.026.49-.333.518-.464.028-.131-.251-.469-.208-.66.015-.064.146-.215.245-.236.098-.022.537.148.636.127.12-.026.26-.153.373-.224a2.42 2.42 0 001.025.202c1.472 0 2.664-1.147 2.664-2.56C9.47 1.921 8.277.778 6.805.778c-1.471 0-2.619 1.147-2.619 2.56zm3.908-.498a.687.687 0 11-1.375 0 .687.687 0 011.375 0z"
      fill="currentColor"
    />
  ),
});
export const BoxTriIcon = createIcon({
  displayName: "CreditIcon",
  viewBox: "0 0 24 24",
  path: (
    <g fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url(#clip0)" fill="currentColor">
        <path d="M9.972 3.675a.086.086 0 000-.148L6.691 1.62a1.378 1.378 0 00-1.382 0L2.028 3.527a.086.086 0 000 .148l3.929 2.312a.086.086 0 00.087 0l3.928-2.312zM1.66 4.26a.086.086 0 00-.129.075V8.07a1.031 1.031 0 00.512.889l3.484 2.089a.086.086 0 00.13-.074V6.64a.086.086 0 00-.044-.074L1.66 4.26zM6.344 6.655v4.318a.086.086 0 00.129.075l3.483-2.09a1.031 1.031 0 00.513-.887V4.335a.085.085 0 00-.043-.074.086.086 0 00-.086 0L6.387 6.58a.086.086 0 00-.043.074z" />
      </g>
      <defs>
        <clipPath id="clip0">
          <path
